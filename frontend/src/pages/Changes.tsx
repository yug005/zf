...
const typeTone: Record<ChangeEventType, string> = {
  ...
  FEATURE_FLAG: 'bg-emerald-50 text-emerald-700 border-emerald-200',
  SSL: 'bg-blue-50 text-blue-700 border-blue-200',
    ...
    <div className="mx-auto max-w-6xl space-y-6 pb-10">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="text-lg font-semibold text-slate-900">Generic CI/CD example</h2>
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="text-lg font-semibold text-slate-900">Provider payload examples</h2>
          <p className="mt-2 text-sm text-slate-500">
          ...
          <div className="mt-4 space-y-4">
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500">GitHub</p>
            ...
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500">Vercel</p>
            ...
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500">Railway</p>
      ...
      <div className="grid gap-6 xl:grid-cols-[1.1fr_1.4fr]">
        <form onSubmit={submit} className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-semibold text-slate-900">Record a change event</h2>
              <p className="text-sm text-slate-500">This becomes part of the incident timeline and likely-trigger engine.</p>
            </div>
          </div>
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <div>
              <label className="mb-1 block text-sm font-medium text-slate-700">Monitor</label>
              <select
            ...
            <div>
              <label className="mb-1 block text-sm font-medium text-slate-700">Change Type</label>
              <select
            ...
            <div>
              <label className="mb-1 block text-sm font-medium text-slate-700">Happened At</label>
              <input
                required
                type="datetime-local"
            ...
            <div>
              <label className="mb-1 block text-sm font-medium text-slate-700">Watch Window (min)</label>
              <input
                type="number"
                min={1}
                max={240}
          ...
          <button
            ...
            className="mt-6 inline-flex items-center rounded-xl bg-slate-900 px-4 py-2 text-sm font-medium text-white hover:bg-slate-800 disabled:opacity-50"
          >
        ...
        <div className="rounded-3xl border border-slate-200 bg-white shadow-sm">
          <div className="border-b border-slate-200 px-6 py-5">
            <h2 className="text-lg font-semibold text-slate-900">Recent change timeline</h2>
                ...
                <div key={change.id} className="px-6 py-5">
                  <div className="flex flex-wrap items-start justify-between gap-3">
                    <div className="min-w-0">
                      ...
                      <p className="mt-3 font-semibold text-slate-900">{change.title}</p>
                      <p className="mt-2 text-sm text-slate-600">{change.summary || 'No extra summary provided.'}</p>
                    </div>
